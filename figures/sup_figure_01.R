...
#Sup_Fig_1_A
DimPlot(bigseu,group.by = "seurat_clusters",label = T,cols=my36colors)+NoLegend()


#Sup_Fig_1_B
DimPlot(bigseu,group.by = "big_cell_cluster2_info",label=F,cols=my36colors[3:6])
...
DimPlot(hcc2, label = T,group.by = "new.ident",cols=my36colors[3:6])

#Sup_Fig_1_D
VlnPlot(bigseu, features = c("nFeature_RNA", "nCount_RNA"), group.by = "lib.method",cols = my36colors,pt.size = 0)
